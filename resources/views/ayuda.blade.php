<x-app-layout>
    <div class="flex items-center justify-center min-h-[60vh]">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            <!-- Documento 1 -->
            <a href="{{ asset('doc/ManualDeUsuarioFCTS.pdf') }}" target="_blank" class="group flex flex-col items-center text-center transition-all duration-300">
            ...
            <!-- Documento 2 -->
            <a href="{{ asset('doc/DocModeloFísicoDeDatos.pdf') }}" target="_blank" class="group flex flex-col items-center text-center transition-all duration-300">
                <div class="mb-4 p-6 bg-white/10 rounded-2xl group-hover:bg-white/20 group-hover:scale-110 transition-all border border-white/5 backdrop-blur-sm">
                    <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
